...
- Open-source contributor onboarding (FRs explain _what_ before the code explains _how_)
...
| ------ | -------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| FR-001 | M        | System shall support user registration via email + password through Clerk                   | POST /auth/sign-up creates user; user appears in Clerk dashboard                           |
